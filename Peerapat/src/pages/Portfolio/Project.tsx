              ...
              <div>
                <div className="Work__Text__Title">
                  <h2>
                    ...
                    >
                      Staff At BangMod hackathon 2023
                    </a>
                  </h2>
                  <p>
                    KMUTT <br />
        ...
        <div className="Project__Container">
          ...
          <div className="Project__Body">
            <p>
              ...
              {"\u00A0"}is a website used to trade securities online. Its
              purpose is to make it more convenient for investors to issue stock
              orders. TradeKub acts as an intermediary between brokers and users
        ...
        <div className="Project__Container">
          ...
          <div className="Project__Body">
            ...
            <p>
              ...
              Facebook page of KMUTT Book Store. However, this approach comes
              with several limitations. For instance, the process of purchasing
              a specific item requires customers to notify store staff and wait
              for a response before proceeding with the purchase. Additionally,
              buyers must complete a money transfer and send a payment slip for
      ...
      <div data-aos="fade-up">
        <div className="Cer__Container">
          <div className="Cer__Container__Text">
            ...
            <p>
              Acquired proficiency in user research, prototyping, wireframing,
