<template>
  <div class="w-full h-full flex flex-col relative bg-[#0C0C0C] text-white">
    ...
    <button
      v-if="showBackToTop"
      @click="scrollToTop"
      class="fixed bottom-8 right-8 bg-[#0C0C0C] text-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg transition-opacity duration-300 z-50 border border-[#181818] hover:cursor-pointer"
